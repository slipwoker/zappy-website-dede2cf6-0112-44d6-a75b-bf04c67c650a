      ...
      if (!window.zappyContactFormLoaded) {
        ...
        try {
          ...
          const response = await fetch('https://api.zappy5.com/api/email/contact-form', {
            ...
            body: JSON.stringify({
              websiteId: 'dede2cf6-0112-44d6-a75b-bf04c67c650a',
              name: data.name || '',
              email: data.email || '',
    ...
    "translations": {
      "en": {
        "consentModal": {
          ...
          "description": "Little Italy uses cookies to enhance your experience, analyze site usage, and assist in our marketing efforts. You can manage your preferences anytime.",
